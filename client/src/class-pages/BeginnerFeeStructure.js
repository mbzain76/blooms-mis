...
class BeginnerFeeStructure extends Component{
  constructor(props){
      super(props);
  }  
...
handleClick = () =>{
  ...
  console.log(this.state.isOpen)
   ...
   componentDidMount(){
    ...
    <ClassFeeMenu  printFee={this.printStructure} path={choosenClass}/>
          ...
          <div className="main">
            ...
            <p  style={basicTitle}>Basic charges</p>
              <div  style={chargesblock} >
                  ...
                  <p style={chargeAmount}>Ksh.{choosenClass ==="Grade 1" || choosenClass ==="Grade 2" ? this.state.feesStructure.grade1Tuition : this.state.feesStructure.beginnerTuition} </p>
                </div>

                <div style={chargesblock}>
        
                    <p style={chargeType}>Lunch</p>
                     <p style={chargeAmount}>Ksh. {choosenClass ==="Grade 1" || choosenClass ==="Grade 2" ? this.state.feesStructure.grade1Lunch : this.state.feesStructure.beginnerLunch}</p>
                 </div>
                <div style={chargesblock}>
...
export default BeginnerFeeStructure;