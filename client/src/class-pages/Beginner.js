...
console.log(this.state.beginnerStuds.length)
    ...
    render(){
      localStorage.setItem('class', 'Beginner')
        return(
            
                          <div className="parentContainer">
        <GreyBar />
        <div className = "content">
        <ClassListMenu title="Students / Beginner" path={"/beginner-fee-structure"} searched = {this.state.searchText} searching={this.getSearch} filterDisplay = {this.state.filter} filter = {this.onFilterClick} searchfunc = {this.toggleSearch} searchBar = {this.state.display} toggleCheck={this.onCheckClick}/>
            
        <SideBar  emailPath={"/student-email-selected"} check={this.getChecked}/>

          <div className="main">
            <div className="componentContainer">
                <ClassListSubTab number = { this.state.beginnerStuds.length}tab="Beginner" />
               <FullNameTab />
                <DaycareList  filtered={this.state.beginnerStuds} retrieveS = {this.getChecked} view = {this.state.searchText} checkVisible = {this.state.checkIcon} classLevel="Beginner" students = {this.state.students}/>
