...
class ClassFeeStructure extends Component{
  constructor(props){
      super(props);
  }  
...
handleClick = () =>{
  ...
  console.log(this.state.isOpen)
    ...
    printStructure = () =>{
      ...
      var content = document.getElementsByClassName("componentContainer")[0];
    ...
    <ClassFeeMenu printFee={this.printStructure} path="Class"/>
            
     <SideBar />
          <div className="main">
            <div className="componentContainer">
            
            <FeeSubTab  tabTitleProp="Day care Fee Structure" display={this.state.isOpen} handle={this.handleClick}/>
            <p  style={basicTitle}>Basic charges</p>
              <div style={chargesblock} >
                  <p style={chargeType}>Tuition</p>
                  <p style={chargeAmount}>Ksh.{this.state.feesStructure.dayCareTuition} </p>
                </div>
                <div style={chargesblock}>
                            <p style={chargeType}>Lunch</p>
                     <p style={chargeAmount}>Ksh. {this.state.feesStructure.dayCareLunch}</p>
                 </div>
                <div  style={chargesblock}>
                    <p style={chargeType}>Swimming</p>
                     <p style={chargeAmount}>Ksh.{this.state.feesStructure.dayCareSwimming}</p>
                </div>
                ...
                <p style={basicTitle} >Optional charges</p>   
                <div style={chargesblock} >
                ...
                <p style={basicTitle}>Transport charges</p>
                <div style={chargesblock}>
                      ...
                      <div style={chargesblockLast}>
                          ...
                          <p style={basicTitle}>Sibling discounts</p>
                          <div style={chargesblock}>
